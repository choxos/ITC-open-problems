...
$(cat critique/design-for-critique-r4-b.md)"
opencode run --pure -m opencode-go/kimi-k3 "$P" > critique/kimi-critique-r4b.txt 2> critique/kimi-critique-r4b.err < /dev/null
echo "kimi done exit=$? bytes=$(wc -c < critique/kimi-critique-r4b.txt)"
