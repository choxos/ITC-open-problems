...
$(cat critique/design-for-critique-r3-b.md)"
opencode run --pure -m opencode-go/kimi-k3 "$P" > critique/kimi-critique-r3b.txt 2> critique/kimi-critique-r3b.err < /dev/null
echo "kimi done exit=$? bytes=$(wc -c < critique/kimi-critique-r3b.txt)"
