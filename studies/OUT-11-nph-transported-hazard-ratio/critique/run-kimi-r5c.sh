...
$(cat critique/design-for-critique-r5-c.md)"
opencode run --pure -m opencode-go/kimi-k3 "$P" > critique/kimi-critique-r5c.txt 2> critique/kimi-critique-r5c.err < /dev/null
echo "kimi c done exit=$? bytes=$(wc -c < critique/kimi-critique-r5c.txt)"
