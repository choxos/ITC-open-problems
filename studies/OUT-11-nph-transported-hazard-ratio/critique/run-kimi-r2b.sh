...
$(cat critique/design-for-critique-r2-short.md)"
opencode run --pure -m opencode-go/kimi-k3 "$P" > critique/kimi-critique-r2.txt 2> critique/kimi-critique-r2.err < /dev/null
echo "kimi done exit=$? bytes=$(wc -c < critique/kimi-critique-r2.txt)"
