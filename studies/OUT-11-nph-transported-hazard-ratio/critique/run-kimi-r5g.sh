...
$(cat critique/design-for-critique-r5-g.md)"
opencode run --pure -m opencode-go/kimi-k3 "$P" > critique/kimi-critique-r5g.txt 2> critique/kimi-critique-r5g.err < /dev/null
echo "kimi g done exit=$? bytes=$(wc -c < critique/kimi-critique-r5g.txt)"
