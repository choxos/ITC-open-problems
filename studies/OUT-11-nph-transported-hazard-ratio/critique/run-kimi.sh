...
opencode run --pure -m opencode-go/kimi-k3 "$P" > critique/kimi-critique.txt 2> critique/kimi-critique.err < /dev/null
echo "kimi done exit=$? bytes=$(wc -c < critique/kimi-critique.txt)"
