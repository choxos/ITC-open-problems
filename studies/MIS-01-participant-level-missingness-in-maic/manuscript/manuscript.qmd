...
case stayed within `r f3(max(abs(mn$bias[mn$method == "complete_case"])))`. Arm-specific
missingness at high rates defeated every method. Imputation with arm interactions was
the most reliable repair under missing at random.
